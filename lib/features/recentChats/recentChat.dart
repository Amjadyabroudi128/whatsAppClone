        ...
        children: [
          ...
          Expanded(
            child: (_selectedTab == 1 ? const UnreadTab()
                : _selectedTab == 2 ? FavouriteTab(user: user)
                : _buildChatsList()),
          ),
        ],
      ),
                                          ...
                                          child: Column(
                                            children: [
                                              Options(
                                                ...
                                                trailing:
                                                    icons.getIssueIcon(context),
                                                onTap: () async {
                                                  try {
                                                    Navigator.of(context).pop();
                                                    final u = await FirebaseFirestore.instance.collection('users')
                                                        .doc(otherUserId).get();
                                                    if (u.exists) {
                                                      final data = u.data()!;
                                                      ...
                                                      Navigator.push(
                                                        ...
                                                        MaterialPageRoute(
                                                          builder: (_) =>
                                                            ...
                                                            email: data['email'] ?? '', imageUrl: data['image'] ?? '',
                                                            bio: data['bio'] ?? '',
                                                            link: data['link'] ?? '',
                                  ...
                                  builder: (context, presenceSnap) {
                                    ...
                                    if (presenceSnap.hasData &&
                                      ...
                                      final bool receiverIsTyping =
                                          (data['isTypingTo'] as String?) ==
                                              user!.uid;
                                      if (receiverIsTyping) {
                                        subtitle = "Typing";
                                      } else {
                                        subtitle = (msg.file?.isNotEmpty == true) ? "[file]"
                                            : (msg.image?.isNotEmpty == true) ? "[image]" : (msg.text);
                                      }
                                    }
                                    return Options(
                                      context: context,
                                      label: StreamBuilder<bool>(
                                        stream: service.isChatMutedStream(
